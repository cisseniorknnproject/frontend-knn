          ...
          <div className='m-5 grid grid-cols-[1fr_1fr_3fr] max-w-full max-h-[40rem]'>
                 ...
                 Productdetail?.images?.map((val:any,idx:Key) => {
                   return (
                     <div key={idx} className='text-black w-[200px] h-[500px]'>
                      <Image className='snap-center m-3 cursor-pointer rounded-3xl drop-shadow-[0px_4px_4px_rgba(0,0,0,0.25)]' objectFit='contain' key={idx} src={val} width={1000} height={1000} alt={Productdetail.title}/>
                  </div>
                )
              })
            }
            ...
            
            {
              <div className='m-5 flex flex-col rounded-3xl h-[300px] gap-5  bg-white drop-shadow-[0px_4px_4px_rgba(0,0,0,0.25)]'>
                <Image className='w-[400px]  h-full rounded-3xl' objectFit='contain' src={Productdetail?.images[0]} width={1000} height={1000} alt={Productdetail?.title}/>
              </div>
            }
            ...
            <div className='text-black m-5 flex flex-col w-[500px] h-[300px] gap-2  '>
              ...
              <div className='flex flex-col gap-5'>
                  ...
                  <div className='flex flex-row gap-2 items-center'>
                    <p className='text-[20px] bg-[#ff0000]  p-1 rounded-[0.4375rem] text-white font-bold'> -{Productdetail?.discountPercentage}% ส่วนลด</p>
