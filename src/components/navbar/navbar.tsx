    ...
    <div className={`${Style.navbartop}`}>
      <div className="mx-8 grid grid-cols-2 gap-2">
        ...
        <div className="flex items-center justify-end gap-[1.12rem] ">
          <div className="hidden md:flex h-2/6 md:w-96 rounded-3xl items-center justify-end">
            <input
              placeholder="ค้นหาสินค้า"
              type="text"
              className={`pl-4 pr-14 w-full h-full rounded-3xl bg-white boxsearch text-black`}
            />
